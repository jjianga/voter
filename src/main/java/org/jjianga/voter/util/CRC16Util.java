...
public class CRC16Util {
    private static String mask = "A1C0F1D5";
    ...
    public static String crc(String str) {
        byte[] b = StringToHex.hexStringToByteArray(str + mask);
        int crc = CRC16Util.calcCrc16(b, 0, b.length);
        String rCrc = Integer.toHexString(crc).toUpperCase();
        return rCrc;
    }

    public static void main(String[] args) {
        System.out.println(Integer.toHexString(calcCrc16(new byte[]{0x33,0x32})));
    }
